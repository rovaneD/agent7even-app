...
function CheckoutRedirect() {
  ...
  if (error) {
    return (
      <div className="text-center">
        ...
        <a href="/pricing" className="text-sm font-medium text-[#c8522a] hover:text-[#b8471f] transition-colors">
          ← Back to pricing
        </a>
      </div>
    )
  ...
  return (
    <div className="text-center">
      <Loader2 size={28} className="text-[#c8522a] animate-spin mx-auto mb-4" />
